...
function getOfflineBanksTitle()
{
  ...
  //  if (!empty($banks) and count($banks)) { 12June2024: Commented this out and changed to the preceding line  Tshepo Blom
        foreach ($banks as $bank) {
            //added a check to ensure $bank is an array containing 'title' index
            if (is_array($bank) && isset($bank['title'])) {
                $titles[] = $bank['title'];
            }
        }
    }
