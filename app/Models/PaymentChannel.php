...
class PaymentChannel extends Model
{
    ...
    static $classes = [
        ...
        'Mollie', 'Ngenius', 'PayFast', 'Payfort', 'Payhere', 'Payku', 'Paylink', 'Paypal',
        'Paysera', 'Paystack', 'Paytm', 'Payu', 'Razorpay', 'Robokassa', 'Sslcommerz',
        'Stripe', 'Toyyibpay', 'Voguepay', 'Zarinpal', 'JazzCash', 'IPay88', 'Xendit', 'Paytabs', 'Paymob', 'Cintepay', 'TapPayment', 'Ozow'
    ];

    static $gatewayIgnoreRedirect = [
        'PayFast', 'Paytm', 'Payu', 'Zarinpal', 'Stripe', 'Paysera', 'Cashu',
        'Payhere', 'Authorizenet', 'Voguepay', 'Payku', 'KlarnaCheckout', 'Izipay', 'Iyzipay',
        'JazzCash', 'IPay88', 'Paytabs', 'Paymob', 'Cintepay', 'Ozow'
    ];
    static $payfast = 'PayFast';
    static $ozow = 'Ozow';
